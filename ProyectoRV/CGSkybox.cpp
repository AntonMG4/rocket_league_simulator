...
void CGSkybox::InitCubemap()
{
	...
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_X, "textures/skybox_right.png");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, "textures/skybox_left.png");
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, "textures/skybox_down.png");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, "textures/skybox_up.png");
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, "textures/skybox_back.png");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, "textures/skybox_front.png");
